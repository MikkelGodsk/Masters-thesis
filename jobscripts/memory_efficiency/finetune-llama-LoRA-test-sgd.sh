...
python finetune.py --model_name "meta-llama/Llama-2-7b-hf" --test True --profile True --backprop_trick False --num_epochs 1 --max_seq_length 256 --no_eval True --optimizer sgd --use_lora True --use_quantization True