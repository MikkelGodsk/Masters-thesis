...
papermill Detection_dataset_preparation_+_compute_activations.ipynb Detection_dataset_preparation_+_compute_activations_output.ipynb -p dtu_hpc true
...
cd $HOME/msc/jobscripts/detection
bsub < LinVsNonlinProbe.sh