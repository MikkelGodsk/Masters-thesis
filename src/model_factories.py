...
class Factory:
    ...
    def __init__(
        self, cache_dir: str, pretrained_config: Optional[PretrainedConfig] = None
    ):
    ...
    def setup_model(
        self, device_map: str = "auto", model_kwargs: Optional[Dict] = {}
    ) -> None:
    ...
    def setup_mebp(
        ...
        if (
            "T_max" not in lr_scheduler_kwargs.keys()
            and lr_scheduler_cls == torch.optim.lr_scheduler.CosineAnnealingLR
        ):
    ...
    def spawn_factory(cls, architecture_type: str, *args, **kwargs) -> "Factory":
        ...
        if architecture_type in factory_dict:
            ...
            raise ValueError(
                f"Factory for architecture type '{architecture_type}' not found"
            )
...
class Llama2Factory(Factory):
    ...
    def __init__(
        ...
        *args,
        ...
        pretrained_config: Optional[LlamaConfig] = None,
        **kwargs,
    ):
    ...
    def spawn_model(self):
        ...
        model.resize_token_embeddings(
            32001
        )  # https://www.reddit.com/r/LocalLLaMA/comments/15hz7gl/comment/jw4vrdx/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button
...
class OptFactory(Factory):
    ...
    def __init__(
        self, *args, version: str = "125m", model_name: str | None = None, **kwargs
    ):
