...
sys.path.insert(
    0, os.path.abspath("../..")
)  # It needs to go up two levels to find the package, because I said "separate source and build" in the setup... Otherwise only one level.


os.environ["SPHINX_APIDOC_OPTIONS"] = (
    "members,show-inheritance"  # Otherwise it gives a warning about `WARNING: duplicate object description`
)
